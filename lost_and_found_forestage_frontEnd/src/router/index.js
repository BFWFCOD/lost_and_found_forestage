  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "/lostlist",
        name: "lostList",
        component: _import("lost-list")
      },
      {
        path: "/foundlist",
        name: "foundList",
        component: _import("found-list")
      }
    ]
  }
];
...
const mainRoutes = {
  ...
  //   { path: '/main', component: _import('domain'), name: 'main', meta: { title: '首页' } }
  // ],
  beforeEnter(to, from, next) {
    // let token = Vue.$cookies.get("forestageToken");
    // console.log("refresh.forestageToken:" + token);
